...
| `deleted_at`      | The date the product is marked as deleted. We don't remove products entirely, only soft deleting them using a library called `acts_as_paranoid` | No           |
